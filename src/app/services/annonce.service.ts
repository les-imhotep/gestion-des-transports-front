...
export class AnnonceService {
  ...
  listerToutesAnnoncesEnCours(): Observable<Annonce[]>{
    return this._http
    .get(URL_BACKEND+"collaborateur/annonces")
    .pipe(
      map((data: any[]) => data.map(annonces => new Annonce(annonces.id,annonces.jourDeDepart,annonces.heureDeDepart,annonces.lieuDeDepart,annonces.lieuDeDestination,annonces.nombreDeVoyageurs,annonces.vehicule,annonces.collegue,annonces.nombreDePlacesDisponibles)))
    )
  }
}
